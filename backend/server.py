...
@app.route('/api/books/<book_uuid>/chapters/<int:chapter>/'
...
@app.route('/api/books/<book_uuid>/chapters/<int:chapter>/paragraphs/<int:paragraph>/image/versions')
